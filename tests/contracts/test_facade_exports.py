...
EXPECTED_SUBSCRIPTION_WEBAPP_EXPORTS = {
    "TEMPLATE_PATH",
...
EXPECTED_SUBSCRIPTION_SERVICE_EXPORTS = {"SubscriptionService"}


def _assert_frozen_exports(module, expected: set[str]):
    assert set(module.__all__) == expected


def test_admin_api_exports_are_frozen():
    _assert_frozen_exports(admin_api, EXPECTED_ADMIN_API_EXPORTS)


def test_subscription_webapp_exports_are_frozen():
    _assert_frozen_exports(subscription_webapp, EXPECTED_SUBSCRIPTION_WEBAPP_EXPORTS)


def test_subscription_service_exports_are_frozen():
    _assert_frozen_exports(subscription_service, EXPECTED_SUBSCRIPTION_SERVICE_EXPORTS)
